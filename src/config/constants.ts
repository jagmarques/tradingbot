...
export const ESTIMATED_GAS_FEE_MATIC = 0.1; // ~$0.10 per Polygon tx
export const ESTIMATED_SLIPPAGE_POLYMARKET = 0.005; // 0.5% Polymarket CLOB slippage
export const POLYMARKET_TAKER_FEE_PCT = 0.0015; // 0.15% per side taker fee
...
export const QUANT_MAX_POSITIONS = 50; // 10 engines x 5 positions
export const HYPERLIQUID_API_TIMEOUT_MS = 10_000; // 10s API timeout
...
export const QUANT_AI_CACHE_TTL_MS = 30 * 60 * 1000; // 30 min cache
export const QUANT_AI_STOP_LOSS_MAX_PCT = 2; // max 2% stop loss
export const QUANT_AI_KELLY_FRACTION = 0.25; // quarter Kelly

// Quant Risk Management
export const QUANT_DAILY_DRAWDOWN_LIMIT = 25; // $25 daily loss halt
export const QUANT_POSITION_MONITOR_INTERVAL_MS = 10_000; // 10s stop-loss check interval

// Directional Trading Scheduler
export const QUANT_SCHEDULER_INTERVAL_MS = 15 * 60 * 1000; // 15 minutes

// Paper Trading Validation
export const QUANT_PAPER_VALIDATION_DAYS = 14; // 2-week paper trading minimum

// Quant liquidation simulation
export const QUANT_LIQUIDATION_PENALTY_PCT = 1.5; // 1.5% liquidation penalty
