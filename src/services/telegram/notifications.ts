...
export async function notifyQuantTradeEntry(params: {
  ...
  const typeLabel = params.tradeType === "funding" ? "Funding" : params.tradeType === "micro-directional" ? "Micro" : params.tradeType === "mtf-directional" ? "MTF" : params.tradeType === "ichimoku-directional" ? "Ichimoku" : params.tradeType === "cci-trend-directional" ? "CciTrend" : params.tradeType === "psar-directional" ? "PSAR" : params.tradeType === "zlema-directional" ? "ZLEMA" : params.tradeType === "macd-cross-directional" ? "MACDx" : params.tradeType === "trix-directional" ? "TRIX" : params.tradeType === "elder-impulse-directional" ? "Elder" : params.tradeType === "vortex-directional" ? "Vortex" : params.tradeType === "schaff-directional" ? "Schaff" : params.tradeType === "supertrend-directional" ? "ST" : params.tradeType === "tema-directional" ? "TEMA" : params.tradeType === "dema-directional" ? "DEMA" : params.tradeType === "hma-directional" ? "HMA" : params.tradeType === "cci-directional" ? "CCI" : "AI";
  const message =
