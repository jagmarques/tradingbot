...
export const COPY_TRADE_CONFIG = {
  ...
  BIG_CAP_LIQUIDITY_USD: 500_000, // skip tokens with >= $500k liquidity (established, not insider gems)
  GOPLUS_SKIP_LIQUIDITY_USD: 500_000, // skip GoPlus for tokens with >= $500k liquidity (matches big-cap threshold)
};
