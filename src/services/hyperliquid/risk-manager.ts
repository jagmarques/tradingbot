...
export function seedDailyLossFromDb(): void {
  const strategies = ["ai", "psar", "zlema", "vortex", "schaff", "dema", "cci", "aroon", "macd", "zlemav2", "schaffv2", "hft-fade", "hft-t8-tp40-sl3", "hft-t10-tp35-sl4", "hft-t8-tp35-sl4", "hft-t8-tp25-sl5", "hft-t8-tp30-sl5", "hft-t12-tp40-sl3", "hft-t10-tp40-sl3", "hft-t8-tp30-sl3", "hft-t8-tp35-sl3", "hft-t8-tp25-sl3"];
