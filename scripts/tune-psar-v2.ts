// PSAR v2: Calmar-sorted Phase 2 (train), top-30 tested, ADX up to 30.
// Run: npx tsx scripts/tune-psar-v2.ts
...
async function main() {
  ...
  console.log(`=== tune-psar-v2.ts: PSAR v2 (ADX 14-30, Calmar-sorted), ${PAIRS.length} pairs, ${DAYS}d ===`);
