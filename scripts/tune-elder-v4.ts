// Elder Impulse v4: top-3 per ADX (Calmar), extended STAG [6..48], Phase 3 trail tuning.
// Run: npx tsx scripts/tune-elder-v4.ts
...
async function main() {
  ...
  console.log(`=== tune-elder-v4.ts: Elder Impulse v4 (top-3/ADX Calmar, STAG 24-192h, Phase 3 trail), ${PAIRS.length} pairs, ${DAYS}d ===`);
  console.log(`Phase 1: ${PHASE1_GRID.length} combos | Phase 2: top-3/ADX × ${p2Count} risk combos | Phase 3: top-50 × ${p3Count} trail, top-20 tested`);
