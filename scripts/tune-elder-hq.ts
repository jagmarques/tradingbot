// Elder Impulse HQ: picks top winner per ADX level (14-25), Phase 2 for each.
// Run: npx tsx scripts/tune-elder-hq.ts
...
async function main() {
  ...
  console.log(`=== tune-elder-hq.ts: Elder Impulse HQ (ADX 14-25), ${PAIRS.length} pairs, ${DAYS}d ===`);
