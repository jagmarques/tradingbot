// PSAR HQ: picks top winner per ADX level (14-25), Phase 2 for each.
// Run: npx tsx scripts/tune-psar-hq.ts
...
async function main() {
  ...
  console.log(`=== tune-psar-hq.ts: PSAR HQ (ADX 14-25), ${PAIRS.length} pairs, ${DAYS}d ===`);
