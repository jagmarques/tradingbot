// Schaff Trend Cycle v3: Calmar-sorted Phase 1+2 (train), top-30 tested, ADX up to 30, wider STC grid.
// Run: npx tsx scripts/tune-schaff-v3.ts
...
const STC_FAST_VALS = [8, 12, 23];
const STC_SLOW_VALS = [26, 40, 50];
const STC_CYCLE_VALS = [8, 10, 14, 20];
...
async function main() {
  ...
  console.log(`=== tune-schaff-v3.ts: Schaff v3 (ADX 14-30, Calmar-sorted), ${PAIRS.length} pairs, ${DAYS}d ===`);
