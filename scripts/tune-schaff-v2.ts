// Schaff Trend Cycle v2: Calmar-sorted Phase 2 (train), top-30 tested, ADX up to 30, wider STC grid.
// Run: npx tsx scripts/tune-schaff-v2.ts
...
async function main() {
  ...
  console.log(`=== tune-schaff-v2.ts: Schaff v2 (ADX 14-30, Calmar-sorted), ${PAIRS.length} pairs, ${DAYS}d ===`);
