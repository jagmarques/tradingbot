// ZLEMA HQ: picks top winner per ADX level (14-25), Phase 2 for each.
// Run: npx tsx scripts/tune-zlema-hq.ts
...
async function main() {
  ...
  console.log(`=== tune-zlema-hq.ts: ZLEMA HQ (ADX 14-25), ${PAIRS.length} pairs, ${DAYS}d ===`);
