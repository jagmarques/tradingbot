// Elder Impulse v2: Calmar-sorted Phase 2 (train), top-30 tested, ADX up to 30.
// Run: npx tsx scripts/tune-elder-v2.ts
...
async function main() {
  ...
  console.log(`=== tune-elder-v2.ts: Elder Impulse v2 (ADX 14-30, Calmar-sorted), ${PAIRS.length} pairs, ${DAYS}d ===`);
